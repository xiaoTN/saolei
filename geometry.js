...
function cairoNeighbors(gr, gc) {
    ...
    // 各类型的5个共边邻居 (dR, dC, t2)，经数学验证
    const NEIGHBORS = [
        // t=0: (R,C,1),(R,C,3),(R+1,C,2),(R+1,C,3),(R,C-1,1)
        [[0,0,1],[0,0,3],[1,0,2],[1,0,3],[0,-1,1]],
        // t=1: (R,C,0),(R,C,2),(R,C+1,0),(R,C+1,3),(R+1,C,2)
        [[0,0,0],[0,0,2],[0,1,0],[0,1,3],[1,0,2]],
        // t=2: (R,C,1),(R,C,3),(R-1,C,0),(R-1,C,1),(R,C+1,3)
        [[0,0,1],[0,0,3],[-1,0,0],[-1,0,1],[0,1,3]],
        // t=3: (R,C,0),(R,C,2),(R-1,C,0),(R,C-1,1),(R,C-1,2)
        [[0,0,0],[0,0,2],[-1,0,0],[0,-1,1],[0,-1,2]],
    ];
